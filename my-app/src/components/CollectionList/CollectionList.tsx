  ...
  return (
    <div>
      <div className="container m-auto mt-20">
        <h2 className="text-3xl font-800 uppercase mb-5">Summer Collection</h2>
      </div>
      <div className="container m-auto collection-list__gallery grid grid-cols-1 md:grid-cols-6 gap-3">
        ...
        <div className="collection-list__gallery-item relative col-span-1 md:col-span-2 rounded-lg overflow-hidden">
          <img src={Shirts} alt="Collection Image" 
            className="
              w-full h-full 
              object-cover
              transition-scale
          ...
          <h3 className="
            ...
            cursor-pointer
          ">
            Shirts <FiArrowRight className="transition-translate duration-300 translate-x-0 group-hover:translate-x-2" />
          </h3>
        </div>
        <div className="collection-list__gallery-item relative col-span-1 md:col-span-4 aspect-4/3 rounded-lg overflow-hidden">
          <img src={Sweaters} alt="Collection Image" 
            className="
              w-full h-full 
              object-cover
              transition-scale
          ...
          <h3 className="
            ...
            cursor-pointer
          ">
            Sweaters <FiArrowRight className="transition-translate duration-300 translate-x-0 group-hover:translate-x-2" />
          </h3>
        </div>
      </div>
    </div>
